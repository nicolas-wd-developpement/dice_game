$(document).ready(function(){
    ...
    $('#startNewGame').mouseover(function(){
        $('#startNewGame').css('color', '#3880ff').css('textShadow','rgba(61, 194, 255, 1) 3px 3px 3px').css('cursor','pointer');
    });
    ...
    $('#player1Status').mouseover(function(){
            $('#player1Status').css('color', '#3880ff').css('textShadow','rgba(61, 194, 255, 1) 3px 3px 3px').css('cursor','pointer');
    });
    ...
    $('#player2Status').mouseover(function(){
        $('#player2Status').css('color', '#3880ff').css('textShadow','rgba(61, 194, 255, 1) 3px 3px 3px').css('cursor','pointer');
    });
    ...
    $('#playDice').mouseover(function(){
        $('#playDice').css('color', '3880ff').css('textShadow','rgba(61, 194, 255, 1) 3px 3px 3px').css('cursor','pointer');
    });
    ...
    $('#holdScore').mouseover(function(){
        $('#holdScore').css('color', '#3880ff').css('textShadow','rgba(61, 194, 255, 1) 3px 3px 3px').css('cursor','pointer');
    });
